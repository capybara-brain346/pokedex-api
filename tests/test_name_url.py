...
def test_get_pokemons_by_name_found():
...
def test_get_pokemons_by_name_not_found():
    response = client.get("/pokemons/name/NonExistentPokemon")
...
def test_get_pokemons_by_name_invalid_request():
    response = client.get("/pokemons/name/")
